...
type CommissionRecord struct {
	...
	OrderNo       string           `json:"order_no" gorm:"uniqueIndex:idx_order_distributor;size:32;not null;comment:订单号"`
	DistributorID uint             `json:"distributor_id" gorm:"uniqueIndex:idx_order_distributor;not null;comment:分销员ID"`
	Distributor   Distributor      `json:"distributor" gorm:"foreignKey:DistributorID"`
	Level         int              `json:"level" gorm:"not null;default:1;comment:佣金层级:1-一级 2-二级 3-三级"`
