...
type CommissionRecord struct {
	...
	OrderNo       string           `json:"order_no" gorm:"uniqueIndex:idx_order_commission_level;size:32;not null;comment:订单号"`
	...
	Level         int              `json:"level" gorm:"uniqueIndex:idx_order_commission_level;not null;default:1;comment:佣金层级:1-一级 2-二级 3-三级"`
